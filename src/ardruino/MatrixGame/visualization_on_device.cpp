...
#include "device_display_params.h"
...
void visualization_matrix(int matrix[2][2]){
  ...
  myOLED.printNumI(matrix[0][1], number_second_col_x, number_first_row_y);
  myOLED.printNumI(matrix[1][1], number_second_col_x, number_second_row_y);
}
